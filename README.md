...
* face detection
* face recognition (from local database)
* emotion detection (hopefully)
* displaying info about a detected person on screen

## Hardware Requirements

Honestly, God knows. The more CPU/GPU cores, the better.
